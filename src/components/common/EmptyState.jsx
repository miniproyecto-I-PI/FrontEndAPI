 ...
 * EmptyState.jsx
 * ---------------------------------------------------------------------------
 * Estado vacío reutilizable. Los defaults replican exactamente el copy que
 * ya usa la vista "Hoy" (US-04), así que pages/HoyPage.jsx sigue funcionando
 * sin cambios. Otras pantallas (US-02, US-03, US-09) sobreescriben title /
 * description / ctaLabel y pasan `onCta` en vez de `ctaTo` cuando el CTA no
 * debe navegar sino abrir un modal.
 *
 * @param {string}   [title]
...
export default function EmptyState({
  ...
  return (
    <div className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-12">
      <div className="mt-8 bg-paper-card border border-sepia-border rounded-asym-book p-8 md:p-12 text-center max-w-xl mx-auto warm-card-shadow">
